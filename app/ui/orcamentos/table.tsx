...
export default async function OrcamentosTable({
  query,
  currentPage,
}: {
  query: string;
  ...
  const orcamentos = await fetchFilteredOrcamentos(query, currentPage);
              ...
              >
                ...
                <div className="flex w-full items-center justify-between pt-4">
                  <div className="flex justify-end gap-2">
                    <Link href={`/dashboard/obras/${orcamento.id}`}>
